...
class CouponReportLivewire extends BaseLivewireComponent
{
    ...
    public function render()
    {
        ...
        return view('livewire.coupons_report',[
    ...
    public function couponChart()
    {
        ...
        $chart = $coupons->reduce(function ($pieChartModel, $data) {
            return $pieChartModel->addSlice($data["coupon"]["code"], $data["total"],$this->genColor());
    ...
    public function userChart()
    {
        ...
        $chart = $users->reduce(function ($pieChartModel, $data) {
